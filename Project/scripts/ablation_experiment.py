...
# ---------------------------------------------------
# Ablation: smaller input resolution (128x128 instead of 256x256)
# ---------------------------------------------------
ABLATION_DESC = "resize_128x128"
...
for img_name in os.listdir(image_dir):
    ...
    img = load_image(img_path, device=device, size=(128, 128))  # <- smaller resize
